...
def install_status(
    ...
    return InstallStatusResponse(
        ...
        tenant_mode=system_overrides.normalize_tenant_mode(
            raw.get("tenant_mode") or settings.tenant_mode
        ),
    )
...
def install(
    ...
    mode = system_overrides.normalize_tenant_mode(body.tenant_mode)
    data_payload["tenant_mode"] = mode
    if data_payload:
