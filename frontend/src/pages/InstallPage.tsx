      ...
      <Container maxWidth="sm">
        <Paper elevation={0} sx={{ p: 4, border: "1px solid #d5dee5" }}>
          ...
          <Stack component="form" spacing={2} onSubmit={onSubmit}>
            ...
            <TextField
              select
              label={t("install", "tenantMode")}
              value={tenantMode}
              onChange={(e) => setTenantMode(e.target.value as "single" | "multi")}
              helperText={t("install", "tenantModeHint")}
            >
              <MenuItem value="single">{t("install", "tenantModeSingle")}</MenuItem>
              <MenuItem value="multi">{t("install", "tenantModeMulti")}</MenuItem>
            </TextField>
